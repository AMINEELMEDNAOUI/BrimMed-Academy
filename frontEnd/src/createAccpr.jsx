...
function createAccpr () {
    ...
    const handleSubmit = event => {
        ...
        axios.post('http://localhost:8080/api/professors/register', values)
          .then(response => {
            if (response.data.status === 'success') {
              setAlert({ show: true, message: 'teacher added successfully', type: 'success' });
              setValues({
                nom: '',
                prenom: '',
                mail: '',
              ...
              setAlert({ show: true, message: 'Error adding teacher: ' + response.data.message, type: 'error' });
            }
          })
          .catch(error => {
            console.error('Error adding teacher:', error);
            setAlert({ show: true, message: 'Error adding teacher: ' + error.message, type: 'error' });
          });
      };
          ...
          <div className='divinit'>
            ...
            <img src='/imageeduc.png' alt='education image' className='imageedu'/>
               <div className="create">
                <h3 className='h3create'>Create Account for new teacher</h3>
               ...
               <div className='firstlast'>
                <div className='firstname'>
                    ...
                    <div className='password'>
                    <label htmlFor='password' className='lastlabel'>Salary</label>
                    <input type='number' placeholder=' salary ' name ='salaire' value= {values.salaire} onChange={handleInputChange} required className='form-control ' />
                    </div> 
...
>
<Option value='' disabled hidden>Teaching level </Option>
  ...
  <Option value='2nd year of baccalaureate - Life and Earth Science'>2nd year of baccalaureate - Life and Earth Science</Option>
                    ...
                    <p className='checkbox-group-label'>Subject</p>
                <Checkbox.Group onChange={handleCheckboxChange} value={values.matiereIds}>
                  ...
                  <Checkbox value={3}>SVT</Checkbox>
                    ...
                    <button type='submit' className='loginbutt'>Add Teacher</button>
