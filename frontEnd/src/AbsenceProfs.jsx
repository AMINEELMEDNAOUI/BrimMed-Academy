...
const AbsenceProfs = () => {
    ...
    const fetchAbsences = () => {
        axios.get('http://localhost:8080/api/professors/absences')
            .then(response => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.put('http://localhost:8080/api/professors/updateAbsence', updatedAbsence)
            .then(response => {
    ...
    return (
        <div>
            <h2>Teacher's Absence</h2>
            <button className='updateabs' onClick={handleAbsence}> Update <FontAwesomeIcon icon={faPen} className='iconmanag' /> </button>
            {showModalAbsence &&
